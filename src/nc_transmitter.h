...
#ifndef NC_TRANSMITTER_H
#define NC_TRANSMITTER_H
...
namespace wno {
    ...
    /*!
     * \brief The transmitter class is the public interface for the wno_ofdm transmit chain.
     *  This is the easiest way to start transmitting 802.11a OFDM frames out of the box.
     *
    ...
    public:
         ...
         *
         *  Defaults to:
         *  - sc_map -> 4294967295 (0x00000000FFFFFFFF, last 32 subcarriers)
         ...
         */
        nc_transmitter(uint64_t sc_map = 4294967295, double freq = 5.72e9, double samp_rate = 5e6, double tx_gain = 20, double tx_amp=1.0, std::string device_addr="");
         ...
         *    automatically find an available USRP)
         */
        nc_transmitter(usrp_params params = usrp_params());
    ...
    private:
        ...
        uint64_t m_sc_map; // subcarrier map
